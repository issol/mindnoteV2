...
import SignUpCompleteModal from '../../../modal/sign-up-complete-modal';
...
const SigninPresenter = ({
  ...
  handleSignUpModal,
  hideSignUpModal,
  signupCompleteModalShow,
  handleSignUpCompleteModal,
  hideSignUpCompleteModal,
  completeMessage,
  signUpError,
  handleSubmit,
  onSubmitSignIn,
  ...
  return (
    <div className='px-5 py-5 p-lg-0 bg-surface-secondary'>
      ...
      />
      <SignUpCompleteModal hideSignUpCompleteModal={hideSignUpCompleteModal} completeMessage={completeMessage} signUpError={signUpError} signupCompleteModalShow={signupCompleteModalShow} />
      ...
      <div className='d-flex justify-content-center'>
        <div className='col-lg-5 col-xl-4 p-12 p-xl-20 position-fixed start-0 top-0 h-screen overflow-y-hidden bg-primary d-none d-lg-flex flex-column'>
          <div className='mt-32 mb-20 text-start'>
            <h1 className='ls-tight font-bolder display-6 text-white mb-5'>Connect your ideas and write something new</h1>
            <p className='text-white text-opacity-80'>Any idea doesn't matter. Write it down.</p>
          </div>
        ...
        <div className='col-12 col-md-9 col-lg-7 offset-lg-5 border-left-lg min-h-lg-screen d-flex flex-column justify-content-center py-lg-16 px-lg-20 position-relative'>
          <div className='row'>
            <div className='col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0 text-start'>
              ...
              <div className='my-6 d-flex gap-3 cursor-pointer'>
